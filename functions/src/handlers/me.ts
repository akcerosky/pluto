...
export const meGetHandler = async (request: CallableRequest<unknown>) => {
...
export const meUpdateProfileHandler = async (request: CallableRequest<unknown>) => {
  const uid = assertAuth(request);
...
export const meUsageHistoryHandler = async (request: CallableRequest<unknown>) => {
  const uid = assertAuth(request);
