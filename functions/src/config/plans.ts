...
export const MODE_OUTPUT_TOKEN_BUDGETS: Record<ChatMode, number> = {
...
export const getEffectiveMaxOutputTokens = (
  mode: ChatMode,
  planConfig: Pick<PlanDefinition, 'maxOutputTokensPerRequest'>
) => Math.min(MODE_OUTPUT_TOKEN_BUDGETS[mode], planConfig.maxOutputTokensPerRequest);
