...
export const PDF_SYMBOL_FALLBACKS: Record<string, string> = {
  '₹': 'Rs.',
  '°C': 'deg C',
  '°F': 'deg F',
  '°': 'deg',
...
export const normalizeQuestionPaperWhitespace = (value: string) =>
  value.replace(/\s+/g, ' ').trim();

export const sanitizeQuestionPaperText = (value: string) => {
...
export const sanitizePdfRenderableText = (value: string) => {
