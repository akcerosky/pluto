const formatDate = (value: string | null | undefined) => {
  if (!value) return 'your current billing cycle end date';
...
const renderTemplate = ({
  ...
  intro,
  body,
  footer = 'Thanks for learning with Pluto.',
}: {
  title: string;
  intro: string;
  body: string;
...
export const subscriptionActivated = (name: string, plan: string, endDate: string | null) =>
  renderTemplate({
...
export const subscriptionCharged = (
  name: string,
  plan: string,
  amount: number,
...
export const subscriptionCancelled = (name: string, plan: string, endDate: string | null) =>
  renderTemplate({
...
export const subscriptionPaused = (name: string, plan: string) =>
  renderTemplate({
...
export const subscriptionExpired = (name: string) =>
  renderTemplate({
...
export const refundRequested = (name: string, plan: string, amount: number) =>
  renderTemplate({
