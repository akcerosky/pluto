...
const getExamFormatOverride = (examBoard) => EXAM_FORMAT_OVERRIDES[examBoard] ?? null;
const toFormatPayloadFromOverride = (examBoard, override) => ({
...
export const EXAM_FORMAT_OVERRIDES = {
    'JEE Mains': {
        sections: [
